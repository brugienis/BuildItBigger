 ...
 * on 2016-02-25 at 03:52:08 UTC 
 * Modify at your own risk.
 */

package au.com.kbrsolutions.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getJokeFromJavaLibrary".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetJokeFromJavaLibrary#execute()} method to invoke the remote
   * operation.
   *
   * @return the request
   */
  public GetJokeFromJavaLibrary getJokeFromJavaLibrary() throws java.io.IOException {
    GetJokeFromJavaLibrary result = new GetJokeFromJavaLibrary();
    initialize(result);
    return result;
  }

  public class GetJokeFromJavaLibrary extends MyApiRequest<au.com.kbrsolutions.backend.myApi.model.MyBean> {
     ...
     * parameters, call the {@link GetJokeFromJavaLibrary#execute()} method to invoke the remote
     * operation. <p> {@link GetJokeFromJavaLibrary#initialize(com.google.api.client.googleapis.servic
     * es.AbstractGoogleClientRequest)} must be called to initialize this instance immediately after
     * invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetJokeFromJavaLibrary() {
      super(MyApi.this, "GET", REST_PATH, null, au.com.kbrsolutions.backend.myApi.model.MyBean.class);
    }
    ...
    @Override
    public GetJokeFromJavaLibrary setAlt(java.lang.String alt) {
      return (GetJokeFromJavaLibrary) super.setAlt(alt);
    }

    @Override
    public GetJokeFromJavaLibrary setFields(java.lang.String fields) {
      return (GetJokeFromJavaLibrary) super.setFields(fields);
    }

    @Override
    public GetJokeFromJavaLibrary setKey(java.lang.String key) {
      return (GetJokeFromJavaLibrary) super.setKey(key);
    }

    @Override
    public GetJokeFromJavaLibrary setOauthToken(java.lang.String oauthToken) {
      return (GetJokeFromJavaLibrary) super.setOauthToken(oauthToken);
    }

    @Override
    public GetJokeFromJavaLibrary setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetJokeFromJavaLibrary) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetJokeFromJavaLibrary setQuotaUser(java.lang.String quotaUser) {
      return (GetJokeFromJavaLibrary) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetJokeFromJavaLibrary setUserIp(java.lang.String userIp) {
      return (GetJokeFromJavaLibrary) super.setUserIp(userIp);
    }

    @Override
    public GetJokeFromJavaLibrary set(String parameterName, Object value) {
      return (GetJokeFromJavaLibrary) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<au.com.kbrsolutions.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, au.com.kbrsolutions.backend.myApi.model.MyBean.class);
